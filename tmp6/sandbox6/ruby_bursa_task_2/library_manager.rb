...
class LibraryManager
  ...
  def days_to_buy
    ...
    price_penalty = reader_with_book.book_price * 0.0005
    pages_penalty = 0.000003 * reader_with_book.book_price * reader_with_book.book_pages_quantity
    age_penalty = 0.00007 * reader_with_book.book_price * reader_with_book.book.age

    daily_penalty = (price_penalty + pages_penalty + age_penalty).round * 24
    #binding.pry
    days_to_buy = (reader_with_book.book_price / daily_penalty).to_i  
